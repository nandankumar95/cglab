Document: Selective Repeat ARQ.cpp
#include<glut.h>
#include<stdio.h>
#include<stdlib.h>
#include<windows.h>
...
setFont(GLUT_BITMAP_HELVETICA_18);
glColor3f(1.0,1.0,1.0);
drawstring(20.0,435.0,1.0,"* * G R A P H I C A L I L L U S T R A T I O N OF S E L E C T I V E R E P E A T
A R Q P R O T O C O L * *");
glColor3f(1.0,1.0,1.0);
